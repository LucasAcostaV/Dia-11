document.addEventListener("DOMContentLoaded", function() { 
  ...
  botonesDetalles.forEach(function(boton) {
    boton.addEventListener("click", function() {
      ...
      detallesParrafo.textContent = "Estos son los detalles de la version " + version;
  ...
  var informacionVersion5 = "Informacion de la version 5";

  // Lógica para los botones de configuración
  var botonesConfiguracion = document.querySelectorAll(".configuracion");
      ...
      acordeonContainer.innerHTML = `
        <div class="accordion" id="acordeon-${version}">
          <div class="accordion-item">
            ...
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-${version}" aria-expanded="false" aria-controls="collapse-${version}">
              ${informacionVersion}
            </button>
            </h2>
            ...
            <div class="accordion-body">
              Ver la configuracion de la version ${version}.
            </div>
            </div>
          </div>
        </div>
  ...
  function obtenerArchivos(version) {
    ...
    if (version === "1") {
      return ["archivo1.txt", "archivo2.pdf", "archivo3.jpg"];
        ...
        return ["archivo9.png","archivo10.xls","archivo11.html"];      
    } else {
